...
export default function Users() {
  ...
  const [editUsernameErr, setEditUsernameErr] = useState("");
  const [editPasswordErr, setEditPasswordErr] = useState("");
  ...
  async function handleSaveEdit(id) {
    ...
    setEditUsernameErr(uErr);
    let pErr = "";
    if (editPassword) {
      pErr = validatePassword(editPassword);
      setEditPasswordErr(pErr);
    }
    if (uErr || pErr) return;
    ...
    try {
      ...
      await axios.put(`${API}/api/auth/users/${id}`, body);
    ...
    <Layout title="User Management">
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns: "1fr 1fr 180px 120px",
            gap: 12,
            alignItems: "start",
          }}
        >
          <div>
            ...
            <input
              ...
              style={{
                ...
                borderColor: usernameErr ? "hsl(350,100%,65%)" : undefined,
              }}
          ...
          <div>
            ...
            <input
              ...
              style={{
                width: "100%",
                boxSizing: "border-box",
                borderColor: passwordErr ? "hsl(350,100%,65%)" : undefined,
              }}
              type="password"
          ...
          <div style={{ paddingTop: 22 }}>
            <button
              ...
              style={{
                padding: "10px 16px",
                opacity: creating || !formValid ? 0.5 : 1,
                width: "100%",
              }}
            >
        ...
        >
          {[
            ...
            {
              role: "auditor",
              desc: "Read-only access to compliance page only. Can export reports.",
            },
          ].map((r) => (
            <div
              key={r.role}
              ...
              {users.map((u, i) => (
                <>
                  <tr
                    ...
                    style={{
                      borderBottom:
                        i < users.length - 1 ? "1px solid var(--line)" : "none",
                    }}
                  >
